...
- 이마트 앱 쿠폰 다운로드하여 5% 추가 할인 적용하기.`,
    ...
    bucket: `# 🌟 나의 인생 버킷리스트 (Life Bucket List)
...
3. **오픈소스 프로젝트:** 최코드 교수님 (oss_choi@university.ac.kr)
   - GitHub Pull Request 2회 이상 머지 미션 부여됨.`,
    ...
    memo: `# 📝 아이디어 퀵 메모 (Quick Idea Scratchpad)
