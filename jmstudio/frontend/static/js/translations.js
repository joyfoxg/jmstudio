const translations = {
            ko: {
                ...
                "tooltip_back": "뒤로가기",
                "tooltip_forward": "앞으로가기",
                "tooltip_undo": "되돌리기 (Ctrl+Z)",
                "tooltip_redo": "다시 실행 (Ctrl+Y)",
                "tooltip_bold": "굵게 (Ctrl+B)",
                "tooltip_italic": "기울이기 (Ctrl+I)",
                "tooltip_list": "목록 스타일",
                "tooltip_code": "코드 블록",
                "tooltip_emoji": "이모지 삽입",
                "tooltip_gdrive_sync": "구글 드라이브 동기화 상태",
                "heading_p": "단락",
                "heading_h1": "머리글 1",
                "heading_h2": "머리글 2",
                "heading_h3": "머리글 3",
                "heading_h4": "머리글 4",
                "list_unordered": "글머리 기호 목록",
                "list_ordered": "순서가 지정된 목록",
                "list_checklist": "체크리스트",
                ...
                "chem_desc": "미국 국립의학도서관 PubChem 데이터베이스에서 화합물을 검색하여 분자 구조와 SMILES 코드를 실시간으로 가져옵니다. (한글/영어 모두 지원)",
                ...
                "tab_backlinks": "백링크",
                "lbl_backlinks_title": "백링크 (Backlinks)",
                "msg_no_backlinks": "이 문서를 참조하는 다른 문서가 없습니다.",
                "toc_title": "문서 개요",
                ...
                "settings_editor_size": "에디터 글자 크기",
                ...
                "msg_undo_done": "되돌리기 완료",
                "msg_redo_done": "다시 실행 완료",
                ...
                "delete_confirm_title": "내 서재에서 내릴까요?",
                "delete_confirm_body": "정말 \"{fileName}\" 문서를 내 서재 목록에서 제외하시겠습니까?<br><br><span style='color: var(--text-muted); font-size: 0.9em;'>(※ 실제 컴퓨터 내의 원본 파일은 절대 삭제되지 않고 안전하게 보존됩니다)</span>",
                ...
                "gdrive_setup_step3": "애플리케이션 유형을 <strong>데스크톱 앱</strong>으로 선택하고 만듭니다.",
                ...
                "tag_select_modal_title": "해시태그 문서선택",
                "hashtag_modal_current_tags": "현재 문서 태그",
                "hashtag_modal_add_tag": "태그 추가",
                "placeholder_add_tag_input": "새 태그 입력",
                ...
                "math_label_ang_freq": "각주파수",
                "math_label_attack_prob": "공격 성공 확률",
                "math_label_backpropagation": "역전파",
            ...
            en: {
                ...
                "tooltip_list": "List Style",
                "tooltip_code": "Code Block",
                "tooltip_emoji": "Insert Emoji",
                "tooltip_gdrive_sync": "Google Drive Sync Status",
                "heading_p": "Paragraph",
                "heading_h1": "Heading 1",
                "heading_h2": "Heading 2",
                "heading_h3": "Heading 3",
                "heading_h4": "Heading 4",
                ...
                "tab_backlinks": "Backlinks",
                "lbl_backlinks_title": "Backlinks",
                "msg_no_backlinks": "No documents link to this file.",
                ...
                "delete_confirm_title": "Remove from My Library?",
                "delete_confirm_body": "Are you sure you want to remove \"{fileName}\" from My Library?<br><br><span style='color: var(--text-muted); font-size: 0.9em;'>(※ The original file on your disk will NOT be deleted)</span>",
                ...
                "tag_select_modal_title": "Select Tagged Documents",
